...
def main():
    ...
    print("  export LLM__MODELS='[\"gpt-4\", \"claude-3\"]'")
    print("  export LLM__TEMPERATURE='0.7'")
    print("  export DATABASE__HOST='remote.db.com'")
    print("  export DATABASE__PORT='3306'")
    print("  export CACHE__ENABLED='false'")
